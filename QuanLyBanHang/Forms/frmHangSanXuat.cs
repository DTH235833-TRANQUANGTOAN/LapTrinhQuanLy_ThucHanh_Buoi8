...
namespace QuanLyBanHang.Forms
{
    public partial class frmHangSanXuat : Form
    {
        ...
        private void TaoCacHelpString()
        {
            ...
            helpProvider1.SetHelpString(btnThem, "Thêm mới hãng sản xuất");

            helpProvider1.SetShowHelp(btnSua, true);
            helpProvider1.SetHelpString(btnSua, "Sửa thông tin hãng sản xuất");

            helpProvider1.SetShowHelp(btnXoa, true);
            helpProvider1.SetHelpString(btnXoa, "Xóa hãng sản xuất");

            helpProvider1.SetShowHelp(btnLuu, true);
            helpProvider1.SetHelpString(btnLuu, "Lưu thông tin hãng sản xuất");

            helpProvider1.SetShowHelp(btnHuyBo, true);
            helpProvider1.SetHelpString(btnHuyBo, "Hủy thao tác");

            helpProvider1.SetShowHelp(btnThoat, true);
            helpProvider1.SetHelpString(btnThoat, "Thoát chương trình");

            helpProvider1.SetShowHelp(btnNhap, true);
            helpProvider1.SetHelpString(btnNhap, "Nhập dữ liệu từ Excel");

            helpProvider1.SetShowHelp(btnXuat, true);
            helpProvider1.SetHelpString(btnXuat, "Xuất dữ liệu ra Excel");
        }
    }
}
