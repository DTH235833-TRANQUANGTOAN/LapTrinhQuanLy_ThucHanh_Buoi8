...
namespace QuanLyBanHang.Forms
{
    public partial class frmHoaDon_ChiTiet : Form
    {
        ...
        {
            toolTip1.SetToolTip(cboNhanVien, "Chọn nhân viên lập hóa đơn.");
            toolTip1.SetToolTip(cboKhachHang, "Chọn khách hàng mua hàng.");
            toolTip1.SetToolTip(cboSanPham, "Chọn sản phẩm muốn bán.");
            toolTip1.SetToolTip(numSoLuongBan, "Nhập số lượng sản phẩm muốn bán.");
            toolTip1.SetToolTip(numDonGiaBan, "Nhập đơn giá bán sản phẩm.");
            toolTip1.SetToolTip(txtGhiChuHoaDon, "Nhập ghi chú cho hóa đơn (nếu có).");
            toolTip1.SetToolTip(btnXoa, "Nhấn vào đây để xóa sản phẩm đã chọn khỏi hóa đơn.");
            toolTip1.SetToolTip(btnLuuHoaDon, "Nhấn vào đây để lưu hóa đơn.");
            toolTip1.SetToolTip(btnXacNhanBan, "Nhấn vào đây để thêm sản phẩm vào hóa đơn hoặc cập nhật thông tin sản phẩm đã có trong hóa đơn.");
            toolTip1.SetToolTip(dataGridView, "Danh sách sản phẩm trong hóa đơn. Bạn có thể chọn một sản phẩm để xóa hoặc cập nhật thông tin.");
            toolTip1.SetToolTip(btnThoat, "Nhấn vào đây để thoát màn hình");
