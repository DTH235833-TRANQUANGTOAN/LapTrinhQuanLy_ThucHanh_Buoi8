...
namespace QuanLyBanHang.Forms
{
    public partial class frmLoaiSanPham : Form
    {
        ...
        {
            toolTip1.SetToolTip(btnThem, "Nhấn vào đây để thêm loại sản phẩm mới.");
            toolTip1.SetToolTip(btnSua, "Nhấn vào đây để sửa loại sản phẩm đã chọn.");
            toolTip1.SetToolTip(btnXoa, "Nhấn vào đây để xóa loại sản phẩm đã chọn.");
            toolTip1.SetToolTip(btnLuu, "Nhấn vào đây để lưu lại thông tin loại sản phẩm.");
            toolTip1.SetToolTip(btnHuyBo, "Nhấn vào đây để hủy bỏ thao tác đang thực hiện.");
            toolTip1.SetToolTip(btnNhap, "Nhấn vào đây để nhập danh sách loại sản phẩm từ tập tin Excel.");
            toolTip1.SetToolTip(btnXuat, "Nhấn vào đây để xuất danh sách loại sản phẩm ra tập tin Excel.");
            toolTip1.SetToolTip(btnThoat, "Nhấn vào đây để thoát");
            toolTip1.SetToolTip(dataGridView, "Danh sách loại sản phẩm. Bạn có thể chọn một loại sản phẩm để sửa hoặc xóa.");
            toolTip1.SetToolTip(txtTenLoai, "Nhập tên loại sản phẩm.");
        }
    }
}
