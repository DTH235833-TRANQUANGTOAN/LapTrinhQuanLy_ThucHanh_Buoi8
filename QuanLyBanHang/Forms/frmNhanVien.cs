...
namespace QuanLyBanHang.Forms
{
    public partial class frmNhanVien : Form
    {
            ...
            else
            {
                if (xuLyThem)
                {
                    ...
                    else
                    {
                        ...
                        nv.QuyenHan = cboQuyenHan.SelectedIndex;
                    ...
                    using (XLWorkbook workbook = new XLWorkbook(openFileDialog.FileName))
                    {
                        ...
                        if (table.Rows.Count > 0)
                        {
                            foreach (DataRow r in table.Rows)
                            {
                                ...
                                nv.QuyenHan = Convert.ToInt32(r["QuyenHan"].ToString());
                                context.NhanVien.Add(nv);
                            }
                            context.SaveChanges();
        ...
        private void btnXuat_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    new DataColumn("QuyenHan", typeof(int))
                    });
        ...
        {
            toolTip1.SetToolTip(btnThem, "Nhấn vào đây để thêm nhân viên mới.");
            toolTip1.SetToolTip(btnSua, "Nhấn vào đây để sửa thông tin nhân viên đã chọn.");
            toolTip1.SetToolTip(btnXoa, "Nhấn vào đây để xóa nhân viên đã chọn.");
            toolTip1.SetToolTip(btnLuu, "Nhấn vào đây để lưu thông tin nhân viên.");
            toolTip1.SetToolTip(btnHuyBo, "Nhấn vào đây để hủy bỏ thao tác đang thực hiện.");
            toolTip1.SetToolTip(btnTimKiem, "Nhấn vào đây để tìm kiếm nhân viên theo tên hoặc số điện thoại.");
            toolTip1.SetToolTip(btnNhap, "Nhấn vào đây để nhập danh sách nhân viên từ tập tin Excel.");
            toolTip1.SetToolTip(btnXuat, "Nhấn vào đây để xuất danh sách nhân viên ra tập tin Excel.");
            toolTip1.SetToolTip(btnThoat, "Nhấn vào đây để thoát.");
            toolTip1.SetToolTip(dataGridView, "Danh sách nhân viên. Bạn có thể chọn một nhân viên để sửa hoặc xóa.");
            toolTip1.SetToolTip(txtHoVaTen, "Nhập họ và tên nhân viên.");
            toolTip1.SetToolTip(txtDienThoai, "Nhập số điện thoại của nhân viên.");
            toolTip1.SetToolTip(txtDiaChi, "Nhập địa chỉ của nhân viên.");
            toolTip1.SetToolTip(txtTenDangNhap, "Nhập tên đăng nhập của nhân viên.");
            toolTip1.SetToolTip(txtMatKhau, "Nhập mật khẩu của nhân viên. Nếu để trống khi sửa, mật khẩu sẽ không thay đổi.");
            toolTip1.SetToolTip(cboQuyenHan, "Chọn quyền hạn cho nhân viên. 0: Nhân viên, 1: Quản lý.");
